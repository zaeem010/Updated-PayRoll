    ...
    public class EmployeeAttendanceController : Controller
    {
        ...
        public ActionResult Saves(string[] Emp, string StDateTime, string EnDateTime, string[] Remarks)
        {
            ...
            for (int i = 0; i < Emp.Count(); i++)
            {
                ...
                {
                    _context.Database.ExecuteSqlCommand("INSERT INTO CHECKINOUT (USERID, CHECKTIME, Memoinfo) VALUES ('" + Userid + "','" + StDate + "','Direct Attendance') ");
                }
                if (EnDate.Year.ToString() != "1")
                {
                    _context.Database.ExecuteSqlCommand("INSERT INTO CHECKINOUT (USERID, CHECKTIME, Memoinfo) VALUES ('" + Userid + "','" + EnDate + "','Direct Attendance') ");
                }
            }
            TempData["Insert"] = "Inserted Successfully";
